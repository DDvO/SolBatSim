...
#   [-ceff <Lade-Wirkungsgrad in %, ansonsten 90 für AC-gekoppelt, sonst 94>]
...
#   [-ceff <charging efficiency in %, default 90 for AC-coupled, otherwise 94>]
...
if (defined $capacity) {
    $charge_eff  = $AC_coupled ? 0.9 : 0.94 unless defined $charge_eff;
